...
const Catalog = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('http://ec2-35-171-185-33.compute-1.amazonaws.com:8080/products'); // Adjust the URL to match your backend API endpoint
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://ec2-35-171-185-33.compute-1.amazonaws.com:8080/products/${id}`);
    ...
    const handleSave = async (id) => {
        try {
            await axios.put(`http://ec2-35-171-185-33.compute-1.amazonaws.com:8080/product/${id}`, {
                name: tempItem.name,
    ...
    const handleImageChange = async (e) => {
        if (e.target.files && e.target.files[0]) {
            ...
            try {
                const response = await axios.post('http://ec2-35-171-185-33.compute-1.amazonaws.com:8080/upload-image', formData, {
                    headers: {
    ...
    const handleAddProduct = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://ec2-35-171-185-33.compute-1.amazonaws.com:8080/add-product', newProduct);
